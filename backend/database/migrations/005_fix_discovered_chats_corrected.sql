...
-- CORRECTED: Works with existing schema (no 'role' column)
...
-- CORRECTED: Only use columns that exist in your users table
INSERT INTO users (
    id,
    username,
    telegram_id,
...
-- Create RLS policy (CORRECTED: No role column reference)
...
SELECT 'Migration 005_fix_discovered_chats_corrected.sql completed successfully' as result;