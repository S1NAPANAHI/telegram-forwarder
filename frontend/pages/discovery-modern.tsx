...
export default function DiscoveryModern() {
  ...
  const categories = [
    { key: 'all' as const, label: 'همه', icon: GlobeAltIcon },
    { key: 'tech' as const, label: 'تکنولوژی', icon: HashtagIcon },
    { key: 'news' as const, label: 'اخبار', icon: ChatBubbleLeftRightIcon },
    { key: 'entertainment' as const, label: 'سرگرمی', icon: FireIcon },
    { key: 'education' as const, label: 'آموزش', icon: UsersIcon },
    { key: 'business' as const, label: 'کسب و کار', icon: TrendingUpIcon }
  ]

  const sortOptions = [
    { key: 'members' as const, label: 'تعداد اعضا' },
    { key: 'activity' as const, label: 'فعالیت' },
    { key: 'engagement' as const, label: 'میزان تعامل' },
    { key: 'recent' as const, label: 'جدیدترین' }
  ]
  ...
  return (
    <>
      <Head>
        <title>کشف کانال‌ها - تلگرام فوروارد</title>
        <meta name="description" content="کشف و اضافه کردن کانال‌های جدید" />
      </Head>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              کانال‌های جدید و جالب را کشف کنید و به لیست منابع خود اضافه نمایید
            </p>
          </div>
            ...
            <div className="lg:col-span-3">
              {loading ? (
                <div className="flex items-center justify-center py-12">
                  <LoadingSpinner size="lg" text="در حال جستجوی کانال‌ها..." />
                </div>
              ) : (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-600 dark:text-gray-400">اعضا:</span>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-600 dark:text-gray-400">پست روزانه:</span>
                          <span className="font-semibold text-gray-900 dark:text-white">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-600 dark:text-gray-400">تعامل:</span>
                          <span className="font-semibold text-gray-900 dark:text-white">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-600 dark:text-gray-400">آخرین پست:</span>
                          <span className="font-semibold text-gray-900 dark:text-white">
                            {channel.lastPost}
                          </span>
                        </div>
              ...
              {!loading && filteredChannels.length === 0 && (
                <ModernCard variant="glass" className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    کانالی برای نمایش پیدا نشد
                  </p>
                  <p className="text-sm text-gray-500 dark:text-gray-500 mt-2">
                    فیلترها یا کلیدواژه جستجو را تغییر دهید
                  </p>
                </ModernCard>
              )}
            </div>
