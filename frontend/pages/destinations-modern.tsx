...
export default function DestinationsModern() {
  ...
  return (
    <>
      <Head>
        <title>مقاصد - تلگرام فوروارد</title>
        <meta name="description" content="مدیریت مقاصد فوروارد" />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                مدیریت و نظارت بر مقاصد فوروارد پیام‌ها
              </p>
            </div>
            <ModernButton
              variant="primary"
          ...
          {loading ? (
            <div className="flex items-center justify-center py-12">
              <LoadingSpinner size="lg" text="در حال بارگذاری مقاصد..." />
            </div>
          ) : (
              ...
              {filteredDestinations.map((destination, index) => (
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600 dark:text-gray-400">فوروارد شده:</span>
                      <span className="font-semibold text-gray-900 dark:text-white">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600 dark:text-gray-400">آخرین فعالیت:</span>
        ...
        >
          <div className="space-y-4">
            <ModernInput
              label="نام مقصد"
              placeholder="نام مقصد را وارد کنید"
